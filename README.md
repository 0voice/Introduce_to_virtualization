...
### 8. [基于存储设备、存储子系统的虚拟化](https://github.com/0voice/Introduce_to_virtualization/blob/main/virtualization_type/storage_virtualization/详解存储子系统的虚拟化.md)
